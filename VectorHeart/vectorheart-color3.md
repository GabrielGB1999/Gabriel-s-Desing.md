...
## Colors
The palette draws from the visual language of early computer terminals, night-vision optics, and chemical luminescence — a black field ignited by phosphor lime.

- **Neutral (#040A05):** Green-black. The absolute ground carries the faintest vegetable tinge, as if the darkness itself is biologically active rather than inert.
- **Primary (#44D400):** Phosphor lime. The stripe bundle's signal color. The specific green of CRT displays, radioactive markers, and emergency exits — urgent, synthetic, and precise. Its saturation is extreme; use it with restraint.
- **Secondary (#EEF5E8):** Cool green-white. Flanking slabs and hero typography. Its slight green cast ties the white elements to the primary without overwhelming them.
- **Tertiary (#CC0055):** Hot pink. The accent plane counterweight. Chromatic opposition to the lime primary — where the primary reads as synthetic cold light, the tertiary reads as biological heat.
- **Steel (#446055):** Muted teal steel. All technical labels and structural marks. A desaturated midpoint between the primary and the neutral, functioning as the system's invisible infrastructure color.
- **Accent (#004499):** Deep blue. Reserved for the single corner accent element. Its heavy, saturated coolness anchors the otherwise volatile lime-pink tension of the rest of the palette.

The `glow` token (#289900) is a deeper, less saturated lime used exclusively for the multi-layer bloom behind the stripe bundle. It should never appear as a solid fill in a visible element.
## Typography
