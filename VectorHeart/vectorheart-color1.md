...
## Colors
The palette trades electric urgency for industrial warmth — a molten amber signal burning through a near-black ground with the weight of cast iron.

- **Neutral (#0A0806):** Warm near-black. The ground carries a faint ember undertone — not pure darkness but the darkness of a cold furnace, suggesting latent heat rather than void.
- **Primary (#E8A000):** Industrial amber. The stripe bundle's energy color. The hue of warning lights, molten metal, and cathode glow. It demands attention without the aggression of red or the coldness of cyan.
- **Secondary (#F5EED8):** Warm parchment. Flanking slabs and hero typography. Its yellowed warmth harmonizes with the amber primary, reinforcing the sense of aged industrial material.
- **Tertiary (#8C1A00):** Deep brick red. The accent plane counterweight. Pulled from the same warm family as the primary but heavier, older — the color of oxidized iron rather than molten ore.
- **Steel (#7A6840):** Olive steel. All technical labels and structural marks. A desaturated warm tone that reads as neutral against the amber system without introducing coolness.
- **Accent (#1A3A8A):** Deep navy. Reserved for the single corner accent element. Its cool distance from the warm primary creates the sharpest chromatic tension in the system.

The `glow` token (#C07800) is a deeper, lower-saturation amber used exclusively for the multi-layer bloom behind the stripe bundle. It should never appear as a solid fill in a visible element.
## Typography
