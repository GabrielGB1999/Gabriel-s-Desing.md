...
## Colors
The palette operates at the edge of the visible spectrum — a deep purple-black field split by electric violet, counterweighted by acid chartreuse. It is the color of ultraviolet exposure, blacklight posters, and plasma discharge.

- **Neutral (#07050E):** Deep purple-black. The ground has a perceptible violet cast — not a warm black but a cold, spectral one, as if the darkness itself is irradiated.
- **Primary (#7700FF):** Electric violet. The stripe bundle's energy color. Maximally saturated, sitting at the boundary between visible and invisible light. It reads simultaneously as digital and ceremonial.
- **Secondary (#EFECF8):** Cool lavender white. Flanking slabs and hero typography. Its faint violet tint connects it to the primary without competing for attention, maintaining the spectral coherence of the system.
- **Tertiary (#CCEE00):** Acid chartreuse. The accent plane counterweight. The most extreme chromatic opposite available to violet — a yellow-green so saturated it reads as a chemical warning. One use per composition.
- **Steel (#6858A0):** Muted indigo. All technical labels and structural marks. Pulled toward the primary but desaturated enough to function as an infrastructure color rather than an accent.
- **Accent (#FF3300):** Signal red-orange. Reserved for the single corner accent element. Its heat is the sharpest possible contrast to the cold violet primary, creating a thermal rather than merely chromatic opposition.

The `glow` token (#5500CC) is a deeper, lower-energy violet used exclusively for the multi-layer bloom behind the stripe bundle. It should never appear as a solid fill in a visible element.
## Typography
